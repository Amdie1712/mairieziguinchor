...
const Services: React.FC = () => {
      ...
      
  {
    ...
    desc: "Coordination des activités du Maire, relations institutionnelles, communication officielle et suivi des orientations stratégiques de la commune.",
    icon: "Landmark",
    color: "bg-red-50 text-red-600",
    divisions: ["Protocole", "Communication", "Relations Publiques"]
  },
  {
    title: "Secrétariat Général",
    desc: "Supervision administrative de l’ensemble des services municipaux et coordination des décisions communales.",
    icon: "ShieldCheck",
    color: "bg-slate-50 text-slate-700",
    divisions: ["Administration", "Coordination", "Archives"]
  },
  {
    title: "Direction de l'État Civil",
    desc: "Gestion des actes de naissance, mariage, décès, certificats administratifs et formalités citoyennes.",
    icon: "FileBadge",
    color: "bg-blue-50 text-blue-600",
    divisions: ["Naissances", "Mariages", "Décès", "Légalisation"],
    path: "/etat-civil"
  },
  {
    title: "Direction des Services Techniques",
    desc: "Gestion des infrastructures urbaines, de la voirie, de l’assainissement et des équipements publics.",
    icon: "Construction",
    color: "bg-orange-50 text-orange-600",
    divisions: ["Voirie", "Assainissement", "Maintenance"],
    path: "/urbanisme"
  },
  {
    title: "Direction de la Planification",
    desc: "Élaboration et suivi des projets communaux, du PAI, du PTI et des investissements structurants.",
    icon: "MapPinned",
    color: "bg-emerald-50 text-emerald-600",
    divisions: ["PAI", "PTI", "Coopération"],
    path: "/projets"
  },
  {
    title: "Finances & Comptabilité",
    desc: "Gestion budgétaire, mobilisation des recettes municipales et suivi des dépenses publiques.",
    icon: "Wallet",
    color: "bg-amber-50 text-amber-600",
    divisions: ["Budget", "Recettes", "Patrimoine"]
  },
  {
    title: "Ressources Humaines",
    desc: "Administration du personnel communal, gestion des carrières, formation et suivi des agents.",
    icon: "BriefcaseBusiness",
    color: "bg-purple-50 text-purple-600",
    divisions: ["Personnel", "Formation", "Carrières"]
  },
  {
    title: "Cellule Informatique",
    desc: "Digitalisation des services municipaux, maintenance informatique et gestion des plateformes numériques.",
    icon: "MonitorSmartphone",
    color: "bg-cyan-50 text-cyan-600",
    divisions: ["Maintenance", "Applications", "Réseaux"]
  },
  {
    title: "Cellule Communication",
    desc: "Diffusion des informations officielles, gestion des médias et valorisation des actions municipales.",
    icon: "Megaphone",
    color: "bg-pink-50 text-pink-600",
    divisions: ["Presse", "Médias", "Communication Digitale"]
  },
  {
    title: "Passation des Marchés",
    desc: "Gestion des appels d’offres, contrats publics et procédures de passation des marchés communaux.",
    icon: "FileText",
    color: "bg-indigo-50 text-indigo-600",
    divisions: ["Appels d’offres", "Contrats", "Conformité"]
  },
  {
    title: "Affaires Juridiques",
    desc: "Conseil juridique de la commune, traitement des contentieux et sécurisation des actes administratifs.",
    icon: "Scale",
    color: "bg-gray-50 text-gray-700",
    divisions: ["Contentieux", "Conseil Juridique", "Réglementation"]
  },
  {
    title: "Partenariat & Coopération",
    desc: "Développement des partenariats nationaux et internationaux et gestion de la coopération décentralisée.",
    icon: "Handshake",
    color: "bg-green-50 text-green-600",
    divisions: ["Coopération", "Partenaires", "Projets"]
  },
  {
    title: "Éducation & Formation",
    desc: "Appui aux écoles, alphabétisation, formation professionnelle et accompagnement éducatif.",
    icon: "GraduationCap",
    color: "bg-blue-50 text-blue-700",
    divisions: ["Écoles", "Formation", "Alphabétisation"],
    path: "/education"
  },
  {
    title: "Santé & Action Sociale",
    desc: "Accompagnement social des populations vulnérables et soutien aux structures sanitaires communales.",
    icon: "HeartPulse",
    color: "bg-rose-50 text-rose-600",
    divisions: ["Santé", "Action Sociale", "Assistance"],
    path: "/social"
  },
  {
    title: "Jeunesse, Sport & Culture",
    desc: "Promotion des activités sportives, culturelles, artistiques et de loisirs pour la jeunesse.",
    icon: "Trophy",
    color: "bg-violet-50 text-violet-600",
    divisions: ["Sport", "Culture", "Jeunesse"],
    path: "/culture"
  },
            ].map((dept, i) => (
              <div 
